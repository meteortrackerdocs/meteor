...
В настройках роли, в функциональном блоке "Задачи" есть право "**Разрешить переходы между всеми статусами**". Оно предназначено для отключения рабочих потоков. Если вам не нужно ограничивать переходы между статусами, установите это право в роли. Подробнее о ролях и правах можно прочитать в статьях, "[Роли и права](../polzovateli-zapolniteli-i-gruppy/roli-i-prava/)".&#x20;
...
{% hint style="info" %}
Добавлять, изменять рабочие потоки могут пользователи с признаком "**Администратор**" или с правом "**Управление рабочими потоками**" в глобальной роли. Подробнее можно прочесть в статье "[Роли](../polzovateli-zapolniteli-i-gruppy/roli-i-prava/roli.md)".
{% endhint %}
