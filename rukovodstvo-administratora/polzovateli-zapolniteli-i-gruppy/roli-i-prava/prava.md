...
| Копирование проекта             | Создать копию проекта, в который добавлен пользователь с данной ролью                                                                              |
...
Права распространяются на раздел "Время и затраты" в карточке задачи и на раздел "Учет времени" в главном меню (в левом верхнем углу).
...
| Управление рабочими потоками                        | Просматривать, создавать, редактировать, удалять рабочие потоки                                                                                                                                   |

\*Примечание. Возможность создания подпроектов определяется правом "Создание подпроектов" в [роли в проекте](prava.md#prava-rolei-v-proekte).
