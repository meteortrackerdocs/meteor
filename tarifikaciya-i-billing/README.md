...
**Квота на бесплатное использование** —  максимальное значение платежной метрики, при которой использование сервиса METEOR Cloud является бесплатным. Актуальные квоты на бесплатное использование приведены на странице "[Тарифы](https://u-meteor.ru/pricing)".
...
Актуальная стоимость за 1 пользователя указана на странице "[Тарифы](https://u-meteor.ru/pricing)".&#x20;
...
При оплате сервиса METEOR Cloud за год предусмотрена скидка, актуальный размер скидки указан на странице "[Тарифы](https://u-meteor.ru/pricing)". Сумма оплаты за год для получения скидки рассчитывается индивидуально исходя из объема использования.
