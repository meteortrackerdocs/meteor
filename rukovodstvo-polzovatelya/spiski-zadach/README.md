...
Пока вы не создали свои представления, в проекте будет автоматически показан стандартный список всех задач. Найти его можно в верхнем меню на странице проекта — он доступен всегда. Цель вкладки "**Задачи проекта**" - предоставить доступ к списку всех задач проекта для каждого участника.
