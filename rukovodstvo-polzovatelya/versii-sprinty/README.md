...
* в инструменте "**Версии / Спринты**" (открывается меню "+Вид") - раздел для администрирования версий / спринтов.
...
* в инструменте "Версии / спринты";
* на доске по версиям.

### Создание версии / спринта из раздела Версии / спринты

Для создания версии / спринта из раздела "**Версии / спринты"** нажмите кнопку "**Добавить**".
...
Чтобы полностью удалить версию/спринт, перейдите в инструмент "**Версим / спринты**".
