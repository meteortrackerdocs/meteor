...
Все колонки исходной доски перенесутся на новую, которой автоматически присвоится имя с добавлением слова "**Копия**". Копия будет находится в разделе **Мои приватные**, но вы сможете изменить её название и видимость.
