...
2.  Группы пользователей\
    ...
    3.  Нельзя удалить участника из проекта - нужно будет удалить группу из проекта.
        ...
        <div data-gb-custom-block data-tag="hint" data-style="info" class="hint hint-info"><p><strong>Обратите внимание:</strong></p><p>1. Если в проект уже добавлен участник, который является членом группы, то роли группы и пользователя будут суммироваться.</p><p>2. Пользователю можно присвоить дополнительные роли, которые не зависят от роли группы.</p><p>3. Роль, назначенная группе, не может быть изменена для отдельных участников внутри этой группы.</p></div>
